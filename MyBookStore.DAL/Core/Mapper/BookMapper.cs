...
namespace MyBookStore.DAL.Core.Mapper
{
    ...
    public class BookMapper : IEntityTypeConfiguration<Book>
    {
        public void Configure(EntityTypeBuilder<Book> builder)
        {
            ...
            // data migration
            builder.HasData(
                new Book(0, "9b0896fa-3880-4c2e-bfd6-925c87f22878", "CQRS for Dummies", "Good book.", "https://www.996workers.icu", null),
                new Book(1, "0550818d-36ad-4a8d-9c3a-a715bf15de76", "Visual Studio Tips", "Good book 2.", "https://www.996workers.icu", null),
                new Book(2, "8e0f11f1-be5c-4dbc-8012-c19ce8cbe8e1", "NHibernate Cookbook", "Good book 3.", "https://www.996workers.icu", null)
            );
        }
    }
}